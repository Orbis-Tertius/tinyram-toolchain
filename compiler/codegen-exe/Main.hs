...
generate section = do
    ...
    tell $ T.pack $ "// init-symbol: " ++ symbolName ++ " " ++ sectionName ++ " " ++ show addr ++  "\n"
    ...
    where
      ...
      sectionName = elfSectionName section

      symbolName = sectionName ++ "__beginning"
